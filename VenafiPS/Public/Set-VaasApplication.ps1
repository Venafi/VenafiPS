function Set-VaasApplication {
    ...
    .EXAMPLE
    Set-VaasApplication -ID 'ca7ff555-88d2-4bfc-9efa-2630ac44c1f2' -Name 'ThisAppNameIsBetter'

    Rename an existing application

    .EXAMPLE
    Set-VaasApplication -ID 'MyApp' -TeamOwner 'GreatTeam'

    Change the owner to this team

    .EXAMPLE
    Set-VaasApplication -ID 'MyApp' -TeamOwner 'GreatTeam' -NoOverwrite
    ...
    process {
        ...
        $thisApp = Get-VaasApplication -ID $ID -VenafiSession $VenafiSession
