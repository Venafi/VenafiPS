        ...
        switch -Wildcard ($PSCmdlet.ParameterSetName) {
            ...
            'MachineIdentity*' {
                if ( $PSCmdlet.ParameterSetName -eq 'MachineIdentityAll' ) {
                    ...
                    $params = @{
                        InputObject = Find-VcObject -Type MachineIdentity | Select-Object -Property machineIdentityId
                    ...
                    if ( Test-IsGuid($MachineIdentityID) ) {
                        ...
                        Find-VcObject -Type 'MachineIdentity' -Name $MachineIdentityID | Get-VaasObject
                    }
                }
            ...
            'Machine*' {
                ...
                if ( $PSCmdlet.ParameterSetName -eq 'MachineAll' ) {
                    ...
                    $params = @{
                        InputObject = Find-VcObject -Type Machine
                        ScriptBlock = { $PSItem | Get-VaasObject }
                    }
                    return Invoke-VenafiParallel @params
                }
                    ...
                    if ( Test-IsGuid($MachineID) ) {
                        ...
                        # no lookup by name directly.  search for it and then get details
                        Find-VcObject -Type 'Machine' -Name $MachineID | Get-VaasObject
                    }
                }
